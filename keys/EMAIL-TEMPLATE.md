...
**To:** {{BUYER_EMAIL}}
**Subject:** Your a11y-annotator Pro key

Hi,

Thanks for picking up a11y-annotator Pro. Here's your license key:
...
**To activate:**
1. Open Chrome, click the a11y-annotator icon in your toolbar.
2. Paste the key into the license field and click **Unlock**.
3. Pro unlocks immediately — no restart, no account, no network call. Everything stays local, same as the free tier.
...
Thanks for supporting a small tool,
Eric
