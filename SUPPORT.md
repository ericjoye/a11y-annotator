...
Email **theoyax@gmail.com**. This is a one-person product — there's no ticket system, no chat widget, just a real inbox. Response time: **24-48 hours**, usually faster.
...
1. Email theoyax@gmail.com with your Stripe payment confirmation (receipt email or the last 4 of the card, plus approximate date/time of purchase).
...
**14 days, no questions asked.** Request a refund via the Stripe receipt link in your confirmation email, or email theoyax@gmail.com and we'll refund from the Stripe dashboard directly. See `REFUNDS.md` for the full policy text.
